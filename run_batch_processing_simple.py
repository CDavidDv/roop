...
Versión simplificada - solo face_swapper (sin face_enhancer)
"""
...
def process_single_video(source_path: str, target_path: str, output_path: str, 
    ...
    # Construir comando optimizado - SOLO face_swapper
    cmd = [
        sys.executable, 'run.py',
        '--source', source_path,
        '--target', target_path,
        '-o', output_path,
        '--frame-processor', 'face_swapper',  # Solo face_swapper
        ...
        for line in process.stdout:
            ...
            if line:
                ...
                if any(keyword in line for keyword in [
                    ...
                    'Face-Swapper', 'ROOP.CORE', 'GPU', 'CUDA'
                ]):
                    print(f"  📈 {line}")
...
def process_video_batch(source_path: str, target_videos: list, output_dir: str,
    ...
    print("🚀 INICIANDO PROCESAMIENTO EN LOTE (SIMPLIFICADO)")
    print("=" * 60)
    ...
    print(f"   • Frame Processor: face_swapper (sin face_enhancer)")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(description='Procesar múltiples videos con ROOP (versión simplificada)')
