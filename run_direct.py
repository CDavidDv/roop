#!/usr/bin/env python3
"""
Script directo para Google Colab - Usa los procesadores directamente
"""
...
def process_video_direct(source_path: str, target_path: str, output_path: str, 
    ...
    """Procesar un solo video directamente"""
...
def process_videos_batch(source_path: str, input_folder: str, output_folder: str,
    ...
    print("🚀 INICIANDO PROCESAMIENTO EN LOTE (DIRECTO)")
    print("=" * 60)
    print(f"📸 Source: {source_path}")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Procesar videos con ROOP usando GPU (directo)')
    ...
    print("🎯 PROCESAMIENTO DIRECTO PARA GOOGLE COLAB T4")
    print("=" * 60)
