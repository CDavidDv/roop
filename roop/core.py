...
def limit_resources() -> None:
    ...
    if gpus:
        try:
            ...
            print(f"[ROOP.CORE] ⚠️ Error configurando GPU: {e}")
    else:
        print("[ROOP.CORE] ❌ No se detectaron GPUs")
    ...
    if roop.globals.max_memory:
        ...
        print(f"[ROOP.CORE] Límite de memoria del sistema: {roop.globals.max_memory}GB")
